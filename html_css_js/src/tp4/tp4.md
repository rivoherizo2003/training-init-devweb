...
Créer une page web suivant le modèle d'image suivant:

<img src="letter.png">

Voici le contenu texte de la lettre:
<br>
Dr. Eleanor Gaye
...
HTML, Hypertext Markup Language, and CSS, Cascading Style Sheets, constructs for representing musical scores.
...
Voici les balises que vous devez utiliser address, time, abbr, ol, dl, cite, em, sub